...
This is a project template for [Svelte](https://svelte.dev) + Tailwind apps. It lives
at https://github.com/Piszmog/svelte-tailwind-template.

To create a new project based on this template using [degit](https://github.com/Rich-Harris/degit):

```bash
npx degit Piszmog/svelte-tailwind-template svelte-app
cd svelte-app
```
