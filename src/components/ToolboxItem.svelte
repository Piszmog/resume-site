<script lang="ts">
    /**
     * The name of the toolbox type.
     */
    export let type: string;
    /**
     * The specifics that are part of the toolbox.
     */
    export let specifics: string[];
</script>

<div class="bg-gray-100 border-black bg-opacity-95 border-opacity-60 p-4 border-solid rounded-3xl border-2 flex">
    <div class="ml-2">
        {#if type === "plan"}
